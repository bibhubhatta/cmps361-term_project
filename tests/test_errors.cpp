...
// label. Syntax error in construction of the label or operands. For example,
...
// 3. Insufficient memory for the translation.
// 4. Missing end statement or the end statement is not the last one in the
